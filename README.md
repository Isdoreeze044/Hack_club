...
Game stage:
I just finished coding the player movement and the shooting mechanism and to be honest, it wasn't easy but I am really proud of what I did and I know that one day I will even be better than brackeys.

The part that took me alot of time in the game is the bullet scene. I taught that the same way I coded the player would be the same way I would code the bullet because you know... they both move, but unfortunately game logic doesn't work like that.Even the 2d movement was hell, I had problem with the camera viewing and the player's movement was also messed up until I had to read the docs to know what was wrong and it turns out that due to the way computers render graphics,the y-axis is inverted, so in a nutshell ,that's was what caused my movement issue and oh boy! I do not even want to go into what I experienced in the bullet scene but I am glad I learned from my mistakes anyways.
